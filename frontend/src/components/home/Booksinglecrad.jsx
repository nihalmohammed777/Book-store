...
function Booksinglecrad({book}) {
    const [showmodel,setshowmodel]=useState(false)
  return (
    <div key={book._id} className='border-2 border-gray-500 rounded-lg px-4 m-4 relative hover:shadow-xl '>
